...
sapply(trainSmall_census, function(x) sum(is.na(x)))


library(dplyr)


trainSmall_census$workclass=as.factor(trainSmall_census$workclass)
trainSmall_census$education=as.factor(trainSmall_census$education)
trainSmall_census$maritalstatus=as.factor(trainSmall_census$maritalstatus)
trainSmall_census$occupation=as.factor(trainSmall_census$occupation)
trainSmall_census$relationship=as.factor(trainSmall_census$relationship)
trainSmall_census$sex =as.factor(trainSmall_census$sex )
trainSmall_census$race =as.factor(trainSmall_census$race )
trainSmall_census$nativecountry =as.factor(trainSmall_census$nativecountry )
...
test_census$workclass=as.factor(test_census$workclass)
test_census$education=as.factor(test_census$education)
test_census$maritalstatus=as.factor(test_census$maritalstatus)
test_census$occupation=as.factor(test_census$occupation)
test_census$relationship=as.factor(test_census$relationship)
test_census$sex =as.factor(test_census$sex )
test_census$race =as.factor(test_census$race )
...
accuracy=(8864+2038)/nrow(test_census)
accuracy
